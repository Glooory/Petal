package com.glooory.petal.app.net;

import com.glooory.petal.app.rx.RxBus;
import com.glooory.petal.mvp.model.entity.FileLoadBean;
...
public abstract class FileDownloadCallback implements Callback<ResponseBody>{
    ...
    private void subscribeLoadProgress() {
        rxSubscriptions.add(RxBus.getInstance().toObservable(FileLoadBean.class)
